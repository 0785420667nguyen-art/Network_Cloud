...
\begin{itemize}
    ...
    \item \textbf{Cài đặt SDN Controller:} Triển khai Ryu Framework, phát triển các module (Topology Discovery, Flow Management, Statistics Collection, REST API).
    \item \textbf{Cấu hình Open vSwitch:} Cài đặt OVS trên các node, kết nối đến SDN Controller, cấu hình OpenFlow version.
