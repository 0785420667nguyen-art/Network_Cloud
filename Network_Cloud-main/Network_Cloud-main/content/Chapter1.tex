...
Nội dung báo cáo được trình bày trong ba chương như sau:
\begin{itemize}
    ...
    \item Chương 3: Phân tích và thiết kế hệ thống. Phân tích chi tiết hai mô hình mạng chính: mạng phẳng và mạng phân tầng 3 lớp, với đầy đủ ưu điểm, nhược điểm và bảng so sánh tổng quan.
\end{itemize}
